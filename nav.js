class SiteNav extends HTMLElement {
  connectedCallback() {
    // Buscar la ruta relativa al script actual
    const scripts = document.getElementsByTagName('script');
    let src = '';
    for (let script of scripts) {
      if (script.getAttribute('src') && script.getAttribute('src').includes('nav.js')) {
        src = script.getAttribute('src');
        break;
      }
    }
    const basePath = src.replace('nav.js', '');

    this.innerHTML = `
    <nav class="navbar navbar-expand-lg bg-body-tertiary tamaño-estilo-fuente fixed-top" data-bs-theme="dark">
      <div class="container-fluid">
        <a class="navbar-brand text-portfolio" href="#">
          <img src="${basePath}imgs/logos/letra-f.png" alt="Logo" width="30" height="30" class="d-inline-block align-text-top">
          Portfolio
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="${basePath}index.html">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-home" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 12l-2 0l9 -9l9 9l-2 0" />
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-building-arch" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                  <path d="M3 21l18 0" />
              ...
              <ul class="dropdown-menu">
                ...
                <li>
                  <a class="dropdown-item" href="${basePath}diploma_arq.html">
                ...
                <li>
                  <a class="dropdown-item" href="${basePath}proyectos_arq.html">
                ...
                <li>
                  <a class="dropdown-item" href="${basePath}certificaciones_arquitectura.html">
                ...
                <li>
                  <a class="dropdown-item" href="${basePath}exp_laboral_arq.html">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-briefcase-filled" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                ...
                <li><hr class="dropdown-divider border-2"></li>
                
                <li>
                  <a class="dropdown-item" href="${basePath}cv_arq.html">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li>
                  <a class="dropdown-item" href="${basePath}proyectos_prog.html" target="_blank">
                ...
                <li>
                  <a class="dropdown-item" href="${basePath}certificaciones_programacion.html">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-certificate" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                      <path d="M15 15m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" />
                      <path d="M13 17.5v4.5l2 -1.5l2 1.5v-4.5" />
                ...
                <li><hr class="dropdown-divider border-2"></li>
                <li>
                  <a class="dropdown-item" href="${basePath}cv_programacion.html">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-cv" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                      <path d="M14 3v4a1 1 0 0 0 1 1h4" />
                      <path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" />
            ...
            <li class="nav-item dropdown">
              ...
              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <span class="material-symbols-outlined d-inline-block align-text-top" >
                  record_voice_over
                </span>
                Idiomas
              </a>
              <ul class="dropdown-menu">
                <li>
                  <a class="dropdown-item" href="${basePath}certificaciones_ingles.html">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-certificate" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                      <path d="M15 15m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" />
                      <path d="M13 17.5v4.5l2 -1.5l2 1.5v-4.5" />
                ...
                <li><hr class="dropdown-divider border-2"></li>
                <li>
                  <a class="dropdown-item" href="${basePath}cv_ingles.html">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-cv" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                      <path d="M14 3v4a1 1 0 0 0 1 1h4" />
                      <path d="M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z" />
          ...
          <ul class="navbar-nav ms-auto">
            <li class="nav-item-contact">
              <a class="navbar-brand" href="${basePath}contacto.html">
                ...
                <img src="${basePath}imgs/logos/foto_perfil.png" alt="Logo" width="50" height="50" class="d-inline-block align-text-center" style="margin-left: 10px;">
              </a>
            </li>
          </ul>
    ...
    const navLinks = this.querySelectorAll('a.nav-link, a.dropdown-item');
    navLinks.forEach(link => {
      // Ignoramos el basePath al comparar para ser más robustos
      const href = link.getAttribute('href').split('/').pop(); 
      if (href === currentLocation) {
        link.classList.add('active');
        // Si es un dropdown-item, también marcamos como active el dropdown padre
